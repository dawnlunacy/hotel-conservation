...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Booking__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Booking */ "./src/Booking.js");
...
class Customer {
  ...
  addBooking(date, roomNumber) {
    ...
    let booking = new _Booking__WEBPACK_IMPORTED_MODULE_0__["default"](this.id, date, roomNumberInt);
...
/* harmony import */ var _RoomService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./RoomService */ "./src/RoomService.js");
...
class Hotel {
  ...
  instantiateCustomersHelper() {
    this.customers = this.customers.map(customer => {
      ...
      return new _Customer__WEBPACK_IMPORTED_MODULE_0__["default"](customer.name, customer.id, bookings, roomServiceOrders);
    })
  ...
  createCustomer(name) {
    ...
    let customer = new _Customer__WEBPACK_IMPORTED_MODULE_0__["default"](name, id);
  ...
  instantiateBookings() {
    let freshBookings = this.bookings.map(booking => {
      return booking = new _Booking__WEBPACK_IMPORTED_MODULE_2__["default"](booking.userID, booking.date, booking.roomNumber)
    })
  ...
  instantiateRoomService() {
    let freshRoomService = this.roomServiceOrders.map(roomServiceOrder => {
      return roomServiceOrder = new _RoomService__WEBPACK_IMPORTED_MODULE_3__["default"](roomServiceOrder.userID, roomServiceOrder.date, roomServiceOrder.food, roomServiceOrder.totalCost)
    })
  ...
  instantiateRooms() {
    this.freshRooms = this.rooms.map(room => {
      return room = new _Room__WEBPACK_IMPORTED_MODULE_1__["default"](room.number, room.roomType, room.bidet, room.bedSize, room.numBeds, room.costPerNight)
    })
...
const domUpdates =  {
  ...
  appendMainTabDefault(hotel) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-total-rooms-available').text((hotel.findAvailableRoomsByDate()).toLocaleString('en'));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-total-percentage-occupied').text(hotel.findPercentageOfRoomsOccupied() + '%');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-room-service-revenue').text('$' + hotel.findRoomServiceRevenueByDate().toLocaleString('en'));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-total-booking-revenue').text('$' + hotel.findBookingRevenueByDate().toLocaleString('en'));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-total-revenue').text('$' + hotel.findTotalRevenueByDate().toLocaleString('en'));
  },
    
  appendDropDownList(hotel) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#customer-select-dropdown').empty()
    ...
    alphabeticalCustomers.forEach((customer) => {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#customer-select-dropdown').append(option);
    });
  },

  newCustomerEntered(hotel, name) {
    hotel.createCustomer(name);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guide-display').text(name);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.customer-name').text(name);
  },
  ...
  appendMostPopularDate(hotel) {
    ...
    if (dateData.length === 1) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.most-popular-booking-date').text(dateData);
    } else {
      dateData.forEach(date => jquery__WEBPACK_IMPORTED_MODULE_0___default()('.most-popular-booking-date').append(`<li>${date}</li>`));
    }
  },
  ...
  appendMostAvailableRoomsDate(hotel) {
    ...
    if (dateData.length === 1) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.greatest-availability-date').text(dateData);
    } else {
      dateData.forEach(date => jquery__WEBPACK_IMPORTED_MODULE_0___default()('.greatest-availability-date').append(`<li>${date}</li>`));
    }
  },

  loadOrderTableMain(hotel) {
    let orderData = hotel.findRoomServiceOrdersByDate();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-room-service-orders-main').text(orderData.length);
    const orderTableBodyMain = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#table-order-data-main');
    let dataHtml = '';
  ...
  loadOrderTableDefault(hotel, date = hotel.findTodaysDate()) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-room-service-orders').text(orderData.length);
    const orderTableBody = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#table-order-data');
    let dataHtml = '';
    orderData.forEach((order) => {
      let customer = hotel.findCustomerById(order.userID)
      dataHtml += `<tr><td>${order.userID}</td><td>${customer.name}</td><td>${order.food}</td><td> $${order.totalCost}</td></tr>`
  ...
  loadOrderTableCustomerSelected(hotel) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.customer-order-history-total').text(orderData.length);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.customer-order-history-cost').text(`$${hotel.currentCustomer.findRoomServiceCostTotalEver()}`)
    const orderTableBody = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#table-order-customer-data');
    let dataHtml = '';
    orderData.forEach((order) => {
  ...
  prepOrderTableDefault(date) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-room-service-orders').text(' ');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#table-order-data').text('');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.order-default-date').text(date);
  },
  ...
  loadBookingsTable(hotel) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-bookings-details').text(bookingData.length);
    const bookingTableBody = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#bookings-default-table-data');
    let dataHtml = '';
  ...
  prepMainTable() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-bookings-details').text(' ');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#bookings-default-table-data').text(' ');
  },

  prepBookingsTableDefault(date) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-bookings-details').text(' ');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#rooms-available-data').text('');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.rooms-available-default-date').text(date);
  },
  ...
  loadAvailableRoomsTableDefault(hotel, date = hotel.findTodaysDate()) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.total-rooms-available-default').text(availableRoomData.length);
    const availableRoomsTableBody = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#rooms-available-data');
    let dataHtml = '';
  ...
  loadCurrentBookingHistoryForCustomer(hotel) {
    ...
    if (doesCustomerHaveBookingForToday === "YES") {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.book-room-today-btn').attr("disabled", true);
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.book-room-today-btn').attr("disabled", false);
    }
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.customer-booking-today-boolean').text(doesCustomerHaveBookingForToday)
    let currentBookings = hotel.findCurrentBookingsForCurrentCustomer();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.current-bookings-total-number').text(currentBookings.length);
    const CurrentBookingsInfo = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#current-bookings-customer-data');
    let dataHtml = '';
  ...
  prepCurrentBookingsHistoryForCustomer() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#current-bookings-customer-data').text('');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.customer-booking-today-boolean').text('');
  },
  ...
  loadPastBookingHistoryForCustomer(hotel) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.past-bookings-total-number').text(bookingHistory.length);
    const bookedRoomHistory = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#past-bookings-customer-data');
    let dataHtml = '';
  ...
  prepPastBookingsHistoryForCustomer() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#past-bookings-customer-data').text('')
  },
  ...
  displayDateFormat() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.todays-date').text(formatDate);
  ...
  loadAvailableRoomsFilteredForCustomer(hotel, roomType, date = hotel.findTodaysDate()) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.display-filtered-room-available-today').show();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.rooms-available-filter-date').text(date);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.total-rooms-available-filter').text(availableRoomData.length);
    const availableRoomsTableBody = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#rooms-available-filter-data');
    let dataHtml = '';
    availableRoomData.forEach((room) => {
  ...
  prepAvailableRoomFilteredTable() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#rooms-available-filter-data').text('');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.display-filtered-room-available-today').hide();
  },

  addCustomerBookings(hotel, date, roomNumber) {
    let booking = hotel.currentCustomer.addBooking(date, roomNumber);
    hotel.addBooking(booking);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.select-room-by-type').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.display-filtered-room-available-today').hide();
  }
...
module.exports = "images/plant.svg";
...
/* harmony import */ var _images_plant_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./images/plant.svg */ "./src/images/plant.svg");
/* harmony import */ var _images_plant_svg__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_images_plant_svg__WEBPACK_IMPORTED_MODULE_4__);
...
function instantiateHotel(users, bookings, roomServices, rooms) {
  hotel = new _Hotel__WEBPACK_IMPORTED_MODULE_1__["default"](users, bookings, roomServices, rooms);
  hotel.hotelHelper();
  _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].appendMainTabDefault(hotel);
  _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].appendDropDownList(hotel);
  _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].appendMostAvailableRoomsDate(hotel);
  _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].appendMostPopularDate(hotel);
  _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadOrderTableMain(hotel);
  _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadOrderTableDefault(hotel);
  _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadBookingsTable(hotel);
  _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadAvailableRoomsTableDefault(hotel);
  _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].setDefaultValueForCalendars();
}

jquery__WEBPACK_IMPORTED_MODULE_0___default()(function() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tab-labels .tabs li').on('click', function() {
    let $tabLabel = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.tab-labels');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()($tabToHideId).hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()($tabToHideId2).hide();
    

    $tabLabel.find('.tabs li.active').removeClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('active');

    let $tabToShow = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('rel');
    
    $tabLabel.find('.tabLabel-active').slideToggle(200, showCurrentTab());

    function showCurrentTab() {
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guide-display').text() === ' Welcome Admin ') {
        let $tabToShowId = '#' + $tabToShow + '-default'
        jquery__WEBPACK_IMPORTED_MODULE_0___default()($tabToShowId).slideDown(200, function() {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('active');
        });
      }
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guide-display').text() !== ' Welcome Admin ' || $tabToShow === 'main' || $tabToShow === 'customers') {
        let $tabToShowId = '#' + $tabToShow + '-default'
        jquery__WEBPACK_IMPORTED_MODULE_0___default()($tabToShowId).slideDown(200, function() {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('active');
        });
      } 
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guide-display').text() !== ' Welcome Admin ' && $tabToShow === 'rooms') {
        let $tabToHideId = '#' + $tabLabel.find('.tabs li.active').attr('rel') + '-default'
        jquery__WEBPACK_IMPORTED_MODULE_0___default()($tabToHideId).hide() ;
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guide-display').text() !== ' Welcome Admin ' && $tabToShow === 'orders') {
        let $tabToHideId = '#' + $tabLabel.find('.tabs li.active').attr('rel') + '-default'
        jquery__WEBPACK_IMPORTED_MODULE_0___default()($tabToHideId).hide();
        let $tabToShowId = '#' + $tabToShow + '-customer-selected'
        jquery__WEBPACK_IMPORTED_MODULE_0___default()($tabToShowId).slideDown(200, function() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#customer-select-dropdown').on('change', function() {
    let name = (this.value);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].customerSelected(hotel, name);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadOrderTableCustomerSelected(hotel);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadCurrentBookingHistoryForCustomer(hotel);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadPastBookingHistoryForCustomer(hotel);
  });

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.new-user-btn').on('click', function() {
    let name = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.new-user-input').val();
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].newCustomerEntered(hotel, name);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].appendDropDownList(hotel);
  })

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calendar').on('change', function() {
    let date = new Date(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calendar').val());
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.available-booking-date-default-btn').on('click', function(e) {
    e.preventDefault();
    let fixedDate = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calendar-booking-default').val().replace(/-/g, '\/')
    ...
    let yyyy = date.getFullYear();
    let dateSelected = [yyyy, mm, dd].join('/');
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].prepBookingsTableDefault(dateString);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadAvailableRoomsTableDefault(hotel, dateSelected);
    return dateSelected;
  })

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.order-date-default-btn').on('click', function(e) {
    e.preventDefault();
    let fixedDate = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calendar-orders-default').val().replace(/-/g, '\/')
    let date = new Date(fixedDate);
    let dateString = date.toString().split(' ').slice(0, 4).join(' ');
    let dd = String(date.getDate()).padStart(2, '0');
    let mm = String(date.getMonth() + 1).padStart(2, '0');
    let yyyy = date.getFullYear();
    let dateSelected = [yyyy, mm, dd].join('/');
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].prepOrderTableDefault(dateString);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadOrderTableDefault(hotel, dateSelected);
    return dateSelected;
  })

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#current-bookings-customer-data').on('click', '.cancel', function(e) {
    e.preventDefault();
    let date = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)[0].classList[1];
    let roomNumber = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)[0].id;
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].cancelCustomerBookings(hotel, date, roomNumber);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadCurrentBookingHistoryForCustomer(hotel);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadBookingsTable(hotel);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].appendMainTabDefault(hotel);
  })
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.book-room-today-btn').on('click', function(e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.select-room-by-type').show();
  })

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#room-type-select-dropdown').on('change', function(e) {
    e.preventDefault();
    let roomType = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#room-type-select-dropdown option:selected').val();
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadAvailableRoomsFilteredForCustomer(hotel, roomType);
  })

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#rooms-available-filter-data').on('click', '.book', function(e) {
    e.preventDefault();
    let date = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)[0].classList[1];
    let roomNumber = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)[0].id;
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].addCustomerBookings(hotel, date, roomNumber);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadCurrentBookingHistoryForCustomer(hotel);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].loadBookingsTable(hotel);
    _domUpdates__WEBPACK_IMPORTED_MODULE_2__["default"].appendMainTabDefault(hotel);
